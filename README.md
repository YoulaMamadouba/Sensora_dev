...
- ✅ **Masquage des erreurs** sur mobile pour une meilleure UX
...
- Les erreurs sont masquées sur mobile pour une meilleure UX
...
1. **Configurer EAS Build** (si pas déjà fait) :
   ```bash
...
2. **Générer l'APK** :
   ...
   Ou pour une build locale :
   ```bash
   eas build --platform android --local
   ```

3. **Alternative avec Expo** :
   ```bash
